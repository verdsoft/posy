                ...
                {loading ? (
                  ...
                  filteredSales.map((sale) => (
                    <tr key={sale.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-3">${sale.total || "0.00"}</td>
                      <td className="p-3">${sale.paid || "0.00"}</td>
                      <td className="p-3">${sale.due || "0.00"}</td>
                      <td className="p-3">
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="grid grid-cols-2 gap-4 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm">${selectedSale.subtotal || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Tax Amount</label>
                  <p className="mt-1 text-sm">${selectedSale.tax_amount || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Discount</label>
                  <p className="mt-1 text-sm">${selectedSale.discount || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Shipping</label>
                  <p className="mt-1 text-sm">${selectedSale.shipping || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Total</label>
                  <p className="mt-1 text-sm">${selectedSale.total || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Paid</label>
                  <p className="mt-1 text-sm">${selectedSale.paid || "0.00"}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Due</label>
                  <p className="mt-1 text-sm">${selectedSale.due || "0.00"}</p>
                </div>
                {selectedSale.notes && (
