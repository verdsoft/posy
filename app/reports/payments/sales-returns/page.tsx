...
import { useGetSalesReturnPaymentsQuery } from "@/lib/slices/paymentsApi"
...
export default function SalesReturnsPayments() {
  ...
  const { data, isLoading, isFetching } = useGetSalesReturnPaymentsQuery({
  ...
  const handleExportPDF = () => {
    const doc = new jsPDF()
    doc.text('Sales Return Payments Report', 14, 16)
    ...
    autoTable(doc, {
      head: [['Date', 'Reference', 'Sale Return', 'Customer', 'Payment Method', 'Amount']],
      body: tableData,
      startY: 20,
      styles: { fontSize: 8 },
    ...
    doc.save('sales-return-payments.pdf')
  }
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Sales Return Payments")
    XLSX.writeFile(workbook, "sales-return-payments.xlsx")
  }
      ...
      <div className="p-6">
        <div className="mb-6">
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            <span>Reports</span>
            <span>|</span>
            <span>Sales Returns payments</span>
          </div>
          <h1 className="text-2xl font-bold">Sales Returns payments</h1>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left p-3">Sale Return</th>
                ...
                {(isLoading || isFetching) ? (
                  ...
                  payments.map((payment) => (
                    <tr key={payment.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-3">{payment.sale_return_reference}</td>
          ...
          <Dialog open={showViewModal} onOpenChange={setShowViewModal}>
            <DialogContent className="max-w-2xl">
              ...
              <div className="grid grid-cols-2 gap-4 p-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-500">Sale Return Reference</label>
                  <p className="mt-1 text-sm">{selectedPayment.sale_return_reference}</p>
                </div>
                <div>
